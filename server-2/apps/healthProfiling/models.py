...
class PersonalAddress(models.Model):
    ...
    per = models.ForeignKey(Personal, on_delete=models.CASCADE,related_name='addresses')
    add = models.ForeignKey(Address, on_delete=models.CASCADE, related_name='personal_addresses')
