...
class Patients(models.Model):
    ...
    per_id = models.ForeignKey(Personal,on_delete=models.CASCADE,related_name='patients')
...
class PatientRecord(models.Model):
    ...
    pat_id = models.ForeignKey(Patients, on_delete=models.CASCADE, related_name='patient_records')
    created_at = models.DateTimeField(auto_now_add=True)
    class Meta:
