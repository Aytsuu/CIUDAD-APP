...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('patientrecords', '0007_remove_patients_per_id_delete_patientrecord_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('pat_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='patient_records', to='patientrecords.patient')),
            ],
            options={
