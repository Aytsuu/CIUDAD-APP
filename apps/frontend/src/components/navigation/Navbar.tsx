...
export function Navbar() {
  return (
    <header className="h-14 bg-white text-[#263D67] flex items-center justify-between px-6 w-full drop-shadow-md">
      ...
      <div className="flex-1 mx-6 pl-28">
        <div className="relative">
          <Search className="absolute top-1/2 left-3 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
          <input
            type="text"
            placeholder="Search..."
            className="w-2/6 h-9 px-10 py-2 bg-white border-2 border-[#CECECE] rounded-[10px] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400"
          />
        </div>
      </div>
