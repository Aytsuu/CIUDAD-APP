                    ...
                    {!showAttendees ? (
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <Label className={inputlabelcss}>Date</Label>
                                <input type="date" id="date" className="mt-[8px] w-full border border-[#B3B7BD] p-1.5 shadow-sm sm:text-sm focus:outline-none rounded-[3px]" />
                            </div>
                            <div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="time" id="time" className="mt-[8px] w-full border border-[#B3B7BD] p-1.5 shadow-sm sm:text-sm focus:outline-none rounded-[3px]" />
                            </div>
                        </div>
