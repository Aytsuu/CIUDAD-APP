...
export const columns: ColumnDef<Ordinance>[] = [
    {
        ...
        cell: ({row}) => (
            <div className="capitalize">{row.getValue("ordinanceNo")}</div>
        )
    },
    {
        accessorKey: "ordinanceTitle", // Key for location data
...
export const ordinanceRecords: Ordinance[] = [
    {
        ordinanceNo: "001 - 24",
        ordinanceTitle: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."
    },
    {
        ordinanceNo: "003 - 24",
        ordinanceTitle: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."
    ...
    {
        ordinanceNo: "001 - 25",
        ordinanceTitle: "Escucha las palabras de las brujas, los secretos escondidos en la noche, los antiguos dioses invocamos ahora la obra de la."
    },
]

function OrdinancePage() {

    const data = ordinanceRecords;
