...
const columns: ColumnDef<Report>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => (
            <DialogLayout
                trigger={<div className="w-[35px] h-[35px] p-3 border border-gray flex justify-center items-center rounded-[5px] shadow-sm text-[13px]"> View </div>}
                className="max-w-[50%] h-2/3 flex flex-col"
                title="Image Details"
                description="Here is the image related to the report."
                mainContent={<img src="path_to_your_image.jpg" alt="Report Image" className="w-full h-auto" />} // Replace with actual image path
    ...
    },
    {
        ...
        cell: ({ row }) => (
            <TooltipLayout 
                trigger={<div className="w-[35px] h-[35px] bg-[#ff2c2c] text-white border border-gray flex justify-center items-center rounded-[5px] shadow-sm text-[13px]"> <Trash size={16}/> </div>} 
                content="Delete" 
            />
        ),
    },
...
const bodyData: Report[] = [
    {
        ...
        location: "Sitio 1",
        reportDetails: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
        violator: "Unknown",
...
function WasteIllegalDumping() {
    return (
        <div className="mx-4 mb-4 mt-10">
            ...
            <p>ILLEGAL DUMPING REPORTS</p><br></br>
            </div>
            {/* Table for Report Details */}
            <div className="bg-white border border-gray rounded-[5px] p-5">
