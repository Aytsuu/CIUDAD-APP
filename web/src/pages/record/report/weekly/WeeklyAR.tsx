            ...
            <CardContent className="p-0">
              {organizedData.length === 0 ? (
                <div className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground">
                    No weekly accomplishment reports found for {selectedYear}.
                  </p>
                </div>
              ) : (
                        ...
                        <AccordionContent className="px-6 pb-4">
                          ...
                          >
                            {allWeeksInMonth.map((week) => {
                              if (
                                weeks.map(({ weekNo }) => weekNo).includes(week)
                              ) {
                                const filter = weeks.filter(
                                  ({ weekNo }) => weekNo == week
                                )[0];
                              ...
                              if (
                                (missingWeeks.includes(week) &&
                                  missedWeeksPassed >= week) ||
                                (month ==
                                  getMonthName(
                                ...
                                return (
                                  <div className="flex items-center justify-between w-full mr-4">
                                    ...
                                    >
                                      <Button
                                        variant={"link"}
                                        className="text-black/40 text-[13px] hover:text-black/80"
                                      >
                                        <Plus />
                                        Create
                                      </Button>
