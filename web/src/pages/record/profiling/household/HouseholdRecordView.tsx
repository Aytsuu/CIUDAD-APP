    ...
    return (
        ...
        >
                ...
                <CardLayout 
                    content={
                        <div className="w-full flex justify-between">
                            ...
                            <Label>Household Head : {`${personal.per_lname}, ${personal.per_fname} ${personal.per_mname.slice(0,1)}.` || ''}</Label>
            ...
            <CardLayout 
                ...
                content={<DataTable columns={familyColumns(params.data.family)} data={formatFamilyData()}/>}
            />
        </LayoutWithBack>
    )
}