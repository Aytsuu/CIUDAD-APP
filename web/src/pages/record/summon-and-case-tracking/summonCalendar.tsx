...
//       });
//     } else {
//       // Open dialog for time slots when not in edit mode
...
// // Utility to get date string (for comparison)
...
//   const fetchedDateStrings = useMemo(
//     () => new Set(summonDates.map(item => toDateString(item.sd_date))),
//     [summonDates]
//   );
//   const tempSelectedDateStrings = useMemo(
//     () => new Set(tempSelectedDates.map(d => d.toDateString())),
//     [tempSelectedDates]
//   );
...
//     if (!editMode && date < today) return; // Prevent dialog for past dates
...
//   const renderDateCell = (date: Date) => {
//     const dateStr = date.toDateString();
//     const isFetchedDate = fetchedDateStrings.has(dateStr);

//     const isSelected = editMode 
//       ? tempSelectedDateStrings.has(dateStr)
//       : isFetchedDate;
...
//             onChange={() => handleDateSelection(date)}
//             disabled={isPending}
//             aria-label={isSelected ? "Deselect date" : "Select date"}
//           />
//         )}
//       </div>
//     );
...
//                     onClick={handleSave}
//                     disabled={isPending}
//                     aria-label="Save selected dates"
//                   >
//                     {isPending ? "Saving..." : "Save"}
//                   </Button>
//                   <Button 
...
//                 </div>
//               ) : (
//                 <Button onClick={handleEditClick} aria-label="Edit summon dates">
//                   Edit
//                 </Button>
//               )
//             }
...
//               summonDates.find(item => 
//                 selectedDateForDialog && 
//                 toDateString(item.sd_date) === selectedDateForDialog.toDateString()
//               )?.sd_id
//             }
//           />
//         }
