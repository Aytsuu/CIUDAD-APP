...
// import { useGetSummonDates, type SummonDates } from "./queries/summonFetchQueries";
...
//           borderRadius: "4px",
//           cursor: editMode && isAvailable ? "pointer" : "default",
//           opacity: isAvailable ? 1 : 0.5
//         }}
//         onClick={(e) => {
//           if (!editMode || !isAvailable) return;
//           if (e.target === e.currentTarget) {
//             handleDateSelection(date);
//           }
//         }}
//       >
//         {editMode && isAvailable && (
//           <Checkbox 
//             checked={isSelected} 
...
//           color: isSelected ? "#3f51b5" : isAvailable ? "inherit" : "#999"
//         }}>
//         </span>
//       </div>
//     );
...
const SummonCalendar = () => {
  ...
  const handleEditClick = () => {
    // Initialize tempSelectedDates with current selected dates when entering edit mode
    setTempSelectedDates([...selectedDates]);
    setEditMode(true);
  };
