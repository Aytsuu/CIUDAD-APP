    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        if (hasMinutesWithUrl) {
          ...
          if (isDisabled) {
            return (
              <div className="text-gray-400 flex items-center gap-1 justify-center cursor-not-allowed text-center">
                <CircleAlert size={16} />
          ...
          return (
            <DialogLayout
              trigger={
                <div className="text-red-500 flex items-center gap-1 underline justify-center cursor-pointer text-center">
                  <CircleAlert size={16} />
                  <span className="text-xs">No minutes available</span>
                </div>
              }
