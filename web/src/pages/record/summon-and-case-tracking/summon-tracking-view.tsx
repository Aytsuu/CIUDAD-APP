...
function SummonTrackingView() {
  ...
  const [activeTab, setActiveTab] = useState("case-tracker")
  ...
  return (
    <div className="w-full h-full">
      <div className="overflow-y-auto h-full">
        ...
        <div className="w-full mb-8">
          <div className="flex items-center justify-center">
            <div className="inline-flex items-center bg-gray-100 rounded-2xl p-1.5 shadow-inner">
              <button
                onClick={() => setActiveTab("case-tracker")}
                className={`flex items-center gap-3 px-8 py-3 rounded-xl font-semibold text-sm transition-all duration-300 ${
                  activeTab === "case-tracker"
                    ? "bg-white text-blue-700 shadow-lg shadow-blue-100/50 border border-blue-200/50"
              ...
              <button
                onClick={() => setActiveTab("blotter-report")}
                className={`flex items-center gap-3 px-8 py-3 rounded-xl font-semibold text-sm transition-all duration-300 ${
                  activeTab === "blotter-report"
                    ? "bg-white text-emerald-700 shadow-lg shadow-emerald-100/50 border border-emerald-200/50"
                    : "text-gray-600 hover:text-gray-800 hover:bg-gray-50"
                }`}
              >
        ...
        {activeTab === "blotter-report" && <ComplaintRecordForSummon comp_id='1'/>}
      </div>
    </div>
  )
}
