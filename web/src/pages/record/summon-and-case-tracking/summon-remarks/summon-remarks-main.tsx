...
// Format array data to display as comma-separated values
const formatNamesAsCommaSeparated = (data: string[] | string | null | undefined) => {
    if (!data) {
    ...
    const columns: ColumnDef<SummonCaseList>[] = [
        {
          ...
          header: ({ column }) => (
            <div
              className="flex w-full justify-center items-center gap-2 cursor-pointer text-center"
        ...
        },
        {
          ...
          cell: ({ row }) => (
            <div className="min-w-[200px] text-center">
                {formatNamesAsCommaSeparated(row.original.complainant_names)}
            </div>
          ),
        },
        {
          ...
          cell: ({ row }) => (
            <div className="min-w-[200px] text-center">
                {formatNamesAsCommaSeparated(row.original.accused_names)}
            </div>
          ),
        },
        {
            ...
            cell: ({row}) => {
                ...
                return (
                    <div className="flex items-center justify-center text-center">
                        ...
                        >
                            <Button className="flex items-center gap-2 text-primary bg-transparent shadow-none hover:bg-transparent group">
    ...
    if (isInitialLoading && !searchQuery) {
        return (
            <div className="flex items-center justify-center py-12">
                <Spinner size="md" />
                <span className="ml-2 text-gray-600">Loading summon remarks...</span>
            </div>
        );
    }
    ...
    return(
        <div className="w-full h-full flex flex-col">
            ...
            <div className="bg-white rounded-lg shadow-sm">
                {/* Header with Count, Search, and Filters - ALWAYS VISIBLE */}
                ...
                <div className="p-6 pt-0">
                    {isLoading ? (
                        ...
                        // This is the key fix - always show loading spinner when isLoading is true
                        <div className="flex items-center justify-center py-12">
                            <Spinner size="md" />
