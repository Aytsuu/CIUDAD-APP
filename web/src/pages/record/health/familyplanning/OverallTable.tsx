    ...
    <div className="w-full h-full flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex-col items-center mb-4">
          <h1 className="font-semibold text-xl sm:text-2xl text-darkBlue2">Family Planning Records</h1>
          <p className="text-xs sm:text-sm text-darkGray">Manage and view family planning records</p>
        </div>
      </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex flex-col">
                ...
                <div className="flex items-center text-xs text-muted-foreground">
                  {residentFPPercentage >= transientFPPercentage ? <ArrowUp className="h-3 w-3 mr-1 text-green-500" /> : <ArrowDown className="h-3 w-3 mr-1 text-amber-500" />}
          ...
          content={
            <div className="flex items-center justify-between">
              <div className="flex flex-col">
                ...
                <div className="flex items-center text-xs text-muted-foreground">
                  {transientFPPercentage >= residentFPPercentage ? <ArrowUp className="h-3 w-3 mr-1 text-green-500" /> : <ArrowDown className="h-3 w-3 mr-1 text-amber-500" />}
          ...
          content={
            <div className="flex items-center justify-between">
              <div className="flex flex-col">
                ...
                <div className="flex items-center text-xs text-muted-foreground">
                  {minorFPPercentage >= residentFPPercentage ? <ArrowUp className="h-3 w-3 mr-1 text-green-500" /> : <ArrowDown className="h-3 w-3 mr-1 text-amber-500" />}
