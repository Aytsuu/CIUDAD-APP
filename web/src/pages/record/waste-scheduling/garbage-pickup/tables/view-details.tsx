...
export default function ViewGarbageRequestDetails({
  ...
  // Function to handle image click - opens image in new tab
      ...
      <div className="max-w-4xl mx-auto p-6 space-y-6">
        ...
        {file_url && (
          <Card className="border-slate-200 shadow-sm">
            ...
            <CardContent className="pt-6">
              <div 
                className="relative rounded-xl overflow-hidden bg-slate-100 border border-slate-200 cursor-pointer hover:opacity-90 transition-opacity"
              ...
              >
                ...
                <div className="absolute inset-0 bg-black bg-opacity-0 hover:bg-opacity-5 transition-all duration-200 flex items-center justify-center">
                  <span className="text-white bg-black bg-opacity-50 px-3 py-1 rounded-lg text-sm opacity-0 hover:opacity-100 transition-opacity duration-200">
