...
// import { CalendarDays, Clock, MapPin, User, FileText, Trash2, Pen } from "lucide-react"
...
//           {/* Assignment Details Section - Only shows if assignment data exists */}
...
//                     <div className="p-3 bg-purple-50 rounded-lg">
//                       <p className="font-semibold text-slate-900">{assignment_info?.pick_date || "Not scheduled"}</p>
//                     </div>
//                   </div>
//                   <div className="space-y-2">
...
//                         {assignment_info?.pick_time ? formatTime(assignment_info.pick_time) : "Not scheduled"}
//                       </p>
//                     </div>
//                   </div>
//                 </div>
