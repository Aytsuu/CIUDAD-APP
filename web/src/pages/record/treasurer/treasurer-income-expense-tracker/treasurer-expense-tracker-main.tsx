...
//LATEST WORKING W/ QUERY BUT NOT SEPARATED
...
//     // Fetch data from the backend
//     const { data: fetchedData = [], isLoading } = useQuery<IncomeExpense[]>({
...
//             toast.success(
//                 `${
//                     fetchedData.find(item => item.iet_num === iet_num)?.iet_entryType === "Income" 
//                     ? "Income" 
//                     : "Expense"
//                 } deleted successfully`, 
//                 {
