...
//       //   onError: (error) => {
//       //     setIsSubmitting(false);
//       //     toast.error("Failed to submit budget plan");
...
//             {/* Always show "Back to Budget Header" button */}
//             <Button 
//               variant="outline"  
//               onClick={onBack} 
//               className="flex items-center gap-2"
...
//       forms.page1.reset(formData1);
//     } else {
//       // Ensure formData2 has at least one item
...
//     if (currentForm === "page2") {
//       // If we're on withoutLimits, just switch to page1 (withLimits) internally
//       // The parent component's step indicator will be updated via the onBack prop
//       setCurrentForm("page1");
//     } else if (currentForm === "page1") {
//       // If we're on withLimits, go back to header using parent's onBack
//       onBack();
//     }
//   };
