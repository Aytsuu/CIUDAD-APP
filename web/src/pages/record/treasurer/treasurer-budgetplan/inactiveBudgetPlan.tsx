...
export default function InactiveBudgetPlan({ deletedPlanYear, }: {
    ...
    return (
        <div>
            {/* Search + Show entries - ALWAYS VISIBLE */}
            ...
            {/* Content */}
            {isLoadingInactive ? (
                // ALWAYS show loading spinner when isLoadingInactive is true
                // This covers: initial load, page changes, search, etc.
                <div className="flex items-center justify-center py-12">
                    <Spinner size="md" />
                    <span className="ml-2 text-gray-600">
                        {searchQuery ? "Searching archived plans..." : "Loading archived budget plans..."}
                    </span>
                </div>
