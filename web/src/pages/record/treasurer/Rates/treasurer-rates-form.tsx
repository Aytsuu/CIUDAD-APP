    ...
    return (
        <div className="w-full pb-2 bg-snow">
            ...
            <div className="w-full">
                {currentPage === 1 && <RatesPage1 onNext2={handleNext} />}
                {currentPage === 2 && <RatesPage2 onNext3={handleNext} onPrevious1={handlePrevious} />}
                {currentPage === 3 && <RatesPage3 onNext4={handleNext} onPrevious2={handlePrevious} />}
                {currentPage === 4 && <RatesPage4 onNext5={handleNext} onPrevious3={handlePrevious} />}
                {currentPage === 5 && <RatesPage5 onPrevious4={handlePrevious} />}
            </div>
        </div>
    )
}
