...
// import { useGetPurposeAndRateServiceCharge, type PurposeAndRate } from "./queries/RatesFetchQueries"
...
function RatesPage3() {
    ...
    } = useGetPurposeAndRateServiceCharge(
        currentPageActive, 
        pageSizeActive, 
    ...
    if (isLoadingActive && activeTab === "active") {
        return (
            <div className="flex items-center justify-center py-12">
                <Spinner size="md" />
                <span className="ml-2 text-gray-600">Loading active service charges...</span>
            </div>
        )
    }
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        {/* Add Button - Commented but preserved */}
                                        <DialogLayout
                                            trigger={<Button>+ Add</Button>}
                                            title='Add New Range and Fee for Business Permit'
                                            description="Set a new annual gross sales range and its associated fee for business permits."
