...
import { useGetPurposeAndRateServiceChargeActive,  useGetPurposeAndRateAllServiceCharge,  type PurposeAndRate } from "./queries/RatesFetchQueries"
...
function RatesPage3() {
    ...
    } = useGetPurposeAndRateServiceChargeActive(
        currentPageActive, 
        pageSizeActive, 
    ...
    } = useGetPurposeAndRateAllServiceCharge(
        currentPageHistory, 
        pageSizeHistory, 
                            ...
                            trigger={
                                <div>
                                    <DialogLayout
                                        ...
                                        description="Update service charge purpose and rates to keep records accurate."
                                        mainContent={
                                            <RatesEditFormPage3
                                        ...
                                        isOpen={editingRowId === Number(row.original.pr_id)}
                                        onOpenChange={(open) => setEditingRowId(open ? Number(row.original.pr_id) : null)}
                                    />
                                </div>
                            }
                            content="Edit"
        ...
        return (
            <div className="flex items-center justify-center py-12">
                ...
                <span className="ml-2 text-gray-600">
                    {activeTab === "active" ? "Loading active service charges..." : "Loading history..."}
                </span>
            </div>
        )
    }
                                ...
                                <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        {/* <DialogLayout
                                            ...
                                            description="Set a new service charge purpose and rate."
                                            mainContent={
                                                <RatesFormPage3
                                        ...
                                        {activePlans.length > 0 && (
                                            <div className="flex flex-col sm:flex-row justify-between items-center p-4 border-t bg-gray-50">
                                                <p className="text-sm text-gray-600 mb-2 sm:mb-0">
                                                    ...
                                                    of <span className="font-medium">{activeTotalCount}</span> active service charges
                                                </p>
                                        ...
                                        {historyPlans.length > 0 && (
                                            <div className="flex flex-col sm:flex-row justify-between items-center p-4 border-t bg-gray-50">
                                                <p className="text-sm text-gray-600 mb-2 sm:mb-0">
                                                    ...
                                                    of <span className="font-medium">{historyTotalCount}</span> service charge records
                                                </p>
