        ...
        return (
            <div className="w-full h-full">
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-4 flex justify-center">
                    <TabsList className="flex flex-row gap-6 w-full grid-cols-2 max-w-[360px] rounded-full bg-white shadow-md py-6">
                        <TabsTrigger
                            value="minutes"
                            className="data-[state=active]:bg-primary data-[state=active]:text-white rounded-full px-4 py-2"
                        >
