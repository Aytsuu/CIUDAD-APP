...
import { Pencil, Trash, Eye, Plus, Search, Archive, FileInput, Calendar, FileText ,Tag, User} from "lucide-react"
        ...
        <div className="w-full bg-white border-b">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="active" className="m-0">
              {/* Search and Actions Bar - Only show for active tab */}
              {activeTab === "active" && (
                <>
              ...
              {/* Loading State - Only for active tab */}
              {isLoadingActive && activeTab === "active" && (
              ...
              {/* Pagination - Only for active tab */}
              {!isLoadingActive && activeMOMRecords.length > 0 && activeTab === "active" && (
            ...
            {/* Archive Records Tab - Using the imported ArchiveMOM component */}
