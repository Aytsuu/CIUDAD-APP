...
export default function ArchiveMOM() {
    ...
    const { data: inactiveMOMRecordsData, isLoading: isLoadingInactive } = useGetInactiveMinutesOfMeetingRecords(currentPage, debouncedPageSize, debouncedSearchQuery)
        ...
        return (
            <div className="w-full h-full flex items-center justify-center py-12">
                <div className="flex flex-col items-center gap-4">
                    <Spinner size="lg" />
                    <span className="text-gray-600">Loading archived records...</span>
                </div>
            </div>
        )
    }
