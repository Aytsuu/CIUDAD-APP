...
export const columns: ColumnDef<Resolution>[] = [
    {
        ...
        cell: ({row}) => (
            <div className="capitalize w-[140px]">{row.getValue("resNo")}</div>
        )
    },
    {
        accessorKey: "resTitle", // Key for location data
        header: "Resolution Title", // Column header
    },
    {
        accessorKey: "resAreaOfFocus",
        header: "Area of Focus",
        cell: ({ row }) => (
            <div className="text-center space-y-1 w-[150px]"> {/* Add text-left and space-y-1 for spacing */}
                {row.original.resAreaOfFocus.join("\n").split("\n").map((line, index) => (
...
type Resolution = {
    resNo: string
    resTitle: string
    resAreaOfFocus: string[];
}

export const resolutionRecords: Resolution[] = [
    {
        resNo: "001 - 24",
        resTitle: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
        resAreaOfFocus: ["GAD", "Council"]
    },
    {
        resNo: "003 - 24",
        resTitle: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
        resAreaOfFocus: ["Waste Committee", "Council"]
    },
    {
        resNo: "001 - 25",
        resTitle: "Escucha las palabras de las brujas, los secretos escondidos en la noche, los antiguos dioses invocamos ahora la obra de la.",
        resAreaOfFocus: ["GAD", "Finance"]
    },
]
...
function ResolutionPage() {
    ...
    const filterOptions = [
        ...
        const filteredData = filter === "all"
            ? resolutionRecords
            : resolutionRecords.filter(record => record.resAreaOfFocus.includes(filter));
    ...
    return (
        <div className="w-full h-full">
            ...
            <div className='w-full flex justify-between mb-4'>
                ...
                <div>
                    <Link to="/add-res"><Button>Create<Plus className="ml-2" /></Button></Link>
                </div>
            </div>                    
