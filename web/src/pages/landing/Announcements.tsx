      ...
      <section className="px-6 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 text-balance">Public Announcements</h1>
          ...
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-20">
              <div className="relative">
                ...
                <div className="absolute inset-0 w-12 h-12 border-4 border-transparent border-r-cyan-400 rounded-full animate-spin animate-reverse"></div>
              </div>
              <p className="text-slate-300 text-lg font-medium mt-4">Loading announcements...</p>
            </div>
                ...
                >
                  <div className="p-8">
                    <div className="flex items-start justify-between mb-4">
                      <h2 className="text-2xl font-bold text-slate-900 group-hover:text-blue-900 transition-colors duration-200 text-balance leading-tight">
                    ...
                    <p className="text-slate-700 leading-relaxed mb-8 text-pretty line-clamp-3">
            ...
            <div className="text-center py-20">
              ...
              <p className="text-slate-300 max-w-md mx-auto text-pretty">
          ...
          <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
            ...
            <div className="p-8 md:p-12 overflow-y-auto max-h-[90vh]">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-sm font-medium text-blue-600 uppercase tracking-wide">Public Announcement</span>
              </div>
              ...
              <div className="prose prose-lg max-w-none mb-10">
                <p className="text-slate-700 leading-relaxed whitespace-pre-wrap text-pretty">
