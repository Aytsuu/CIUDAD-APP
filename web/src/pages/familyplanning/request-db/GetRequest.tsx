...
//       const dob = personal?.per_dob;
//       const sex = personal?.per_sex || "Unknown";

//       return {
//         fprecord_id: fp.fprecord_id,
//         patient_name: `${lname}, ${fname}`,
//         patient_age: dob ? calculateAge(dob) : "N/A",
//         client_type: patient?.pat_type || "Unknown",
//         method_used: "N/A", // placeholder; update if method is available
