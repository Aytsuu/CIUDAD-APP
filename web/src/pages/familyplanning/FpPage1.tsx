...
//       console.log("Selected Patient Info:", info);


//       // Allowed values for methodCurrentlyUsed
//       const allowedMethods = [
//         "pop", "coc", "injectable", "implant", "iud-interval", "iud-postpartum", "condom",
//         "bom/cmm", "bbt", "stm", "sdm", "lam", "others", "pills", "dmpa", "lactating", "bilateral", "vasectomy"
//       ] as const

//       // Get the current value and ensure it's valid
//       const currentMethod = form.getValues("methodCurrentlyUsed")
//       const validMethod = allowedMethods.includes(currentMethod as any) ? currentMethod : undefined
...
//         address: {
//           ...formData.address, // Keep existing address fields if any
//           street: info.per_address || "",
//           barangay: selectedPatient.per_barangay || "", // Use per_barangay from selectedPatient
//           municipality: info.per_city || "",
//           province: info.per_province || "",
//         },
//         occupation: info.per_occupation || "",
//         religion: info.per_religion || "",
//         spouse: {
//           ...formData.spouse, // Keep existing spouse fields
//           s_lastName: info.spouse_lname || "",
//           s_givenName: info.spouse_fname || "",
//           s_middleInitial: info.spouse_mname || "",
//         },
//         // Ensure that fields potentially used in conditional rendering are initialized
//         typeOfClient: form.getValues("typeOfClient") || "",
//         subTypeOfClient: form.getValues("subTypeOfClient") || "",
//         reasonForFP: form.getValues("reasonForFP") || "",
//         methodCurrentlyUsed: validMethod,
//         otherMethod: form.getValues("otherMethod") || "",
//         reason: form.getValues("reason") || "",
//         // otherReasonForFP: form.getValues("otherReasonForFP") || "",
//         otherReason: form.getValues("otherReason") || "",
//       }

//       // Set all values in the form while preserving any existing values not from the API
//       form.reset({
//         ...form.getValues(), // Keep existing form values
//         ...patientData,     // Override with patient data
//       })
...
//   // if(address){
//   //     form.setValue("motherPersonalInfo.address.street", address.add_street)
//   //     form.setValue("motherPersonalInfo.address.sitio", address.sitio || "")
//   //     form.setValue("motherPersonalInfo.address.barangay", address.add_barangay)
//   //     form.setValue("motherPersonalInfo.address.city", address.add_city)
//   //     form.setValue("motherPersonalInfo.address.province", address.add_province)
//   //           }
...
//               <FormInput control={form.control} name="address.houseNumber" label="ADDRESS" placeholder="No." className="col-span-1 mt-4" />
//               <FormInput
//                 control={form.control}
//                 name="address.street"
//                 label=""
    ...
    if (selectedPatient && selectedPatient.personal_info) {
      ...
      const patientData = {
        ...
        address: {
          ...
          street: info.per_address || "",
          barangay: selectedPatient.per_barangay || "",
          municipality: info.per_city || "",
          province: info.per_province || "",
        },
        occupation: info.per_occupation || "",
        spouse: {
          ...
          s_givenName: info.spouse_fname || "",
          s_middleInitial: info.spouse_mname || "",
          s_dateOfBirth: formData.spouse?.s_dateOfBirth || "",
          s_age: formData.spouse?.s_age || 0,
          s_occupation: info.per_occupation || "",
        },
      }
