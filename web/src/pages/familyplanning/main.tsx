 ...
 useEffect(() => {
  if (followUpPrefillRecord && currentMode === "followup") {
    ...
    const prefillData = {
      ...
      cervicalTenderness: followUpPrefillRecord.fp_pelvic_exam?.cervicalTenderness ?? false,
      cervicalAdnexal: followUpPrefillRecord.fp_pelvic_exam?.cervicalAdnexal ?? false,
