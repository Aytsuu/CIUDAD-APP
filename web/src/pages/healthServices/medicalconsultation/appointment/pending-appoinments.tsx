...
import { Search, FileInput, Loader2, Calendar, MapPin } from "lucide-react";
import { Link } from "react-router-dom";
import { DropdownMenu, DropdownMenuContent, DropdownMenuTrigger, DropdownMenuItem } from "@/components/ui/dropdown/dropdown-menu";
import PaginationLayout from "@/components/ui/pagination/pagination-layout";
import { useState, useEffect } from "react";
import { medicalAppointmentPendingColumns } from "./columns/pendng";
import { usePendingAppointments } from "./queries/get";
...
export default function PendingMedicalAppointments() {
  ...
  const totalPending = apiResponse?.total_pending_appointments || 0;
  ...
  // Calculate this week's appointments count
  const thisWeekAppointmentsCount = appointments.filter(apt => {
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{thisWeekAppointmentsCount}</p>
            </div>
