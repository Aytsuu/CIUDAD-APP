...
export default function ReferredMedicalAppointments() {
  ...
  // Calculate stats based on created_at for referred appointments
  ...
  if (error) {
    return (
      <div className="w-full h-full flex flex-col items-center justify-center p-8">
        <div className="text-red-500 text-lg mb-4">Failed to load referred appointments</div>
            ...
            <div className="w-full h-32 flex flex-col items-center justify-center text-gray-500">
              ...
              <p className="text-sm">
                {debouncedSearch || dateFilter !== "all" || meridiemFilter !== "all" 
                  ? "No referred appointments match your search criteria" 
                  : "No referred appointments at the moment"}
              </p>
            </div>
          ) : (
