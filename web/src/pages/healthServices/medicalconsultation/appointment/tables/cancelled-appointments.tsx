...
export default function CancelledMedicalAppointments() {
  ...
  // Calculate stats based on created_at for cancelled appointments
  ...
  if (error) {
    return (
      <div className="w-full h-full flex flex-col items-center justify-center p-8">
        <div className="text-red-500 text-lg mb-4">Failed to load cancelled appointments</div>
        ...
        <div className="bg-white w-full overflow-x-auto">
          {isLoading ? (
            <div className="w-full h-32 flex flex-col items-center justify-center py-40">
              ...
              <span className="text-gray-600">Loading cancelled appointments...</span>
            </div>
            ...
            <div className="w-full h-32 flex flex-col items-center justify-center text-gray-500 py-40">
              ...
              <p className="text-lg font-medium mb-1">No cancelled appointments found</p>
              <p className="text-sm">
                {debouncedSearch || dateFilter !== "all" || meridiemFilter !== "all" 
                  ? "No cancelled appointments match your search criteria" 
                  : "No cancelled appointments at the moment"}
              </p>
            </div>
          ) : (
