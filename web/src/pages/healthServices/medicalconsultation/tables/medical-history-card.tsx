...
// Medical History Search Component (integrated)
...
export const MedicalHistoryTab: React.FC<MedicalHistoryTabProps> = ({
  ...
  // Memoize the medical history data processing
      ...
      <CardLayout
        ...
        content={
          <div className="overflow-y-auto max-h-96 w-full space-y-1.5 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 hover:scrollbar-thumb-gray-400">
            {isMedHistoryLoading && searchValue ? (
              <div className="flex items-center justify-center py-8">
                <Loader2 className="h-6 w-6 animate-spin text-blue-500 mr-2" />
                <span className="text-gray-600">Searching medical history...</span>
              </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="flex justify-between items-center text-xs">
                        <span className="text-gray-600">
                          recorded from: <span className={`font-medium px-2 py-0.5 rounded-full text-xs ${history.isError ? "text-red-600 bg-red-100" : serviceColor}`}>{history.patrec_type}</span>
                        </span>
                        {!history.isError && (
