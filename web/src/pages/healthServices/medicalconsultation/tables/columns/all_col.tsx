  ...
  return [
    {
      ...
      cell: ({ row }) => (
        <div className="flex">
          <div className="bg-lightBlue text-darkBlue1 px-2 sm:px-3 py-1 rounded-md font-semibold text-xs sm:text-sm">
            {row.original.pat_id || ""}
          </div>
        </div>
      )
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex min-w-[100px] px-2">
          <div className="w-full">{row.original.medicalrec_count}</div>
        </div>
      )
    },
    {
