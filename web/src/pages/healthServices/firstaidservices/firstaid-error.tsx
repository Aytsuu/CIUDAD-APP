...
export function FirstAidRequestError({ mode, selectedPatientData, selectedPatientId }: FirstAidRequestErrorProps) {
  return (
    <div className="mb-4">
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
        <div className="flex items-start gap-2">
          ...
          <div>
            <p className="text-sm font-medium text-amber-900">{mode === "fromindivrecord" && !selectedPatientData ? "Patient Required" : mode === "fromallrecordtable" && !selectedPatientId ? "Patient Required" : "First Aid Items Required"}</p>
