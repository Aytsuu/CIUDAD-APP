...
import MedicineExpiredOutOfStockSummary from "./expoutstock/monthly";
import InventoryMonthlyMedicineRecords from "./monthly";
import { LayoutWithBack } from "@/components/ui/layout/layout-with-back";
import { Package, AlertTriangle } from "lucide-react";

export default function MedicineInventoryReportsTabs() {
  ...
  return (
    <div className="w-full  pb-10">
      <LayoutWithBack
        ...
        description="View and manage medicine inventory reports including stock levels and restock needs."
      >
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full h-full ">
          ...
          <div className="relative">
            <TabsContent value="inventory" className="mt-0">
              <InventoryMonthlyMedicineRecords />
            </TabsContent>

            <TabsContent value="restock" className="mt-0">
              <MedicineExpiredOutOfStockSummary />
            </TabsContent>
          </div>
        </Tabs>
      </LayoutWithBack>
