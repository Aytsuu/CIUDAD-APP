      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-4">
        ...
        <div className="flex-col items-center">
          ...
          <p className="text-xs sm:text-sm text-darkGray">
            View medicine records grouped by month ({monthlyData.length} months found)
          </p>
        </div>
      </div>
                ...
                return (
                  <MonthInfoCard 
                    ...
                    className="[&_.icon-gradient]:from-blue-400 [&_.icon-gradient]:to-blue-600 
                              [&]:hover:border-blue-300 [&_.item-count]:bg-blue-100 
                              [&_.item-count]:text-blue-700 [&_.item-count-dot]:bg-blue-500
                              [&]:group-hover:text-blue-600 [&_.pulse-dot]:bg-blue-500"
                  />
                );
              })}
            </div>
