//// filepath: /c:/CIUDAD-APP/web/src/pages/healthServices/childservices/tables/columns/all_col.tsx
...
export const childColumns: ColumnDef<any>[] = [
  ...
  },
  {
    ...
    header: ({ column }) => (
      <div
        className="flex w-full justify-center items-center gap-2 cursor-pointer py-2"
      ...
      return (
        <div className="flex justify-center items-center  px-2 py-3">
          <div className="flex flex-col space-y-1 items-center">
            <div className="font-medium text-xs sm:text-sm break-words leading-tight text-center">
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="flex justify-center items-center px-2 py-3">
        <div className="w-[160px] sm:w-[250px] text-xs sm:text-sm break-words leading-relaxed text-center">
          {toTitleCase(row.original.address || "UNKNOWN")}
        </div>
      </div>
    ),
  },
    ...
    cell: ({ row }) => (
      <div className="flex justify-center items-center  px-2 py-3">
        <div className="text-xs sm:text-sm text-center">
          {toTitleCase(row.original.sitio || "N/A")}
        </div>
      </div>
    ),
  },
