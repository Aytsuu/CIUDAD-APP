...
export const WFH_BOYS_TABLE: Record<
  number,
  {
...
export const WFH_GIRLS_TABLE: Record<
  number,
  {
    severelyCutoff: number;
    wastedFrom: number;
...
export const LFA_BOYS_TABLE: Record<
  number,
  {
    severelyCutoff: number;
    stuntedFrom: number;
...
export const LFA_GIRLS_TABLE: Record<
  number,
  {
    severelyCutoff: number;
    stuntedFrom: number;
...
export const WFA_GIRLS_TABLE: Record<
  number,
  {
    severelyCutoff: number;
...
export const WFA_BOYS_TABLE: Record<
  number,
  {
    severelyCutoff: number;
    underweightFrom: number;
