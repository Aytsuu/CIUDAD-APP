...
export function PatientSummarySection({
  ...
  return (
    <>
      ...
      <div ref={printRef} className="bg-white p-14 mb-8 border rounded-lg shadow-sm">
                  ...
                  {(() => {
                    ...
                    return (
                      <span className="space-x-2">
                        ...
                        <span>
                          {" "}
                          (<span>{deliveryType === "HC" ? "✓" : " "}</span>) Home
                        </span>
                      </span>
                    );
                  })()}
          ...
          <div className="lg:w-[50%]">
            ...
            <div className="space-y-2 mt-4">
              ...
              <p className="">
                ...
                <span className="underline">
                  {getValueByPath(recordsToDisplay[0], ["tt_status"]) || "N/A"}
                </span>
              </p>
            </div>
          </div>
