...
export default function ChildHRPage1({
  ...
  const isaddnewchildhealthrecordMode =
    mode === "immunization" || mode === "addnewchildhealthrecord";
  ...
  const onSubmitForm = async (data: FormData) => {
    try {
      if (
        ...
        !data.placeOfDeliveryLocation?.trim()
      ) {
        setError("placeOfDeliveryLocation", {
          type: "required",
          message: "Location is required when HC is selected",
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <select
                        {...field}
                        disabled={
                          isaddnewchildhealthrecordMode || !!selectedPatient
                        }
