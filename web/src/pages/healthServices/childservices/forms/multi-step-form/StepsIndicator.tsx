              ...
              <div className="flex flex-col items-center">
                <div
                  className={`
                    ...
                    ${isCompleted ? "bg-blue-600 border-blue-600 text-white shadow-md" : isCurrent ? "bg-blue-100 border-blue-600 text-blue-600 shadow-md" : "bg-gray-100 border-gray-300 text-gray-400"}
                ...
                >
                  ...
                  {isCurrent && <div className="absolute -inset-1 rounded-full border-2 border-blue-300 animate-ping opacity-75"></div>}
                </div>

                {/* Step Title */}
                <div className="mt-2 text-center">
                  <div className="text-xs font-medium text-gray-400 mb-1">Step {step.id}</div>
                  <div className={`text-sm font-medium transition-colors duration-300 ${isCompleted || isCurrent ? "text-blue-600" : "text-gray-400"} ${isClickable ? "group-hover:text-blue-700" : ""}`}>{step.title}</div>
                </div>
              </div>
              ...
              {index < steps.length - 1 && (
                <div
                  className={`
                    ...
                    ${completedSteps.includes(step.id) || step.id < currentStep ? "bg-blue-600" : "bg-gray-300"}
                  `}
                />
              )}
            </div>
