...
export default function MonthlyFirstAidRecords() {
  ...
  return (
    <LayoutWithBack
      ...
      description={`View first aid records grouped by month (${totalMonths} months found)`}>
      <div>
        <Card className="">
            ...
            <div className="bg-white w-full px-4 pt-3">
              {isLoading ? (
                <div className="w-full h-[300px] flex flex-col items-center justify-center text-gray-500">
                  ...
                  <span>Loading first aid records...</span>
                </div>
                ...
                <div className="w-full h-[300px] flex flex-col items-center justify-center text-gray-500 p-8">
                  ...
                  <p className="text-sm text-center text-gray-400">
                    {searchQuery ? "Try adjusting your search criteria" : "No first aid records available"}
                  </p>
                </div>
              )}
