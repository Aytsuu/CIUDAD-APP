...
export default function InventoryMonthlyCommodityRecords() {
  ...
  return (
    <LayoutWithBack title="Monthly Commodity Inventory Reports" description="Review monthly summaries of commodity inventory.">
      <>
        <div>
          <Card className="p-6">
            {/* Header Section */}
            <div className="flex flex-col sm:flex-row gap-4 justify-end items-start sm:items-center mb-6">
              <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                ...
                <div className="relative w-full sm:w-[350px]">
                  ...
                  <Input placeholder="Search by month (e.g. '2025-08')..." className="pl-10 bg-white w-full" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
                </div>
              </div>
            </div>
              ...
              <div className="bg-white w-full">
                {isLoading ? (
                  <div className="w-full h-[300px] flex flex-col items-center justify-center text-gray-500">
                    ...
                    <span>Loading commodity records...</span>
                  </div>
                  ...
                  <div className="w-full h-[300px] flex flex-col items-center justify-center text-gray-500 p-8">
                    ...
                    <p className="text-sm text-center text-gray-400">{searchQuery ? "Try adjusting your search criteria" : "No commodity records available"}</p>
                  </div>
                )}
