...
import FirstAidExpiredOutOfStockSummary from "./expoutstock/monthly";
import MonthlyInventoryFirstAidRecords from "./monthly";

export default function FirstAidInventoryReportsTabs() {
  const [activeTab, setActiveTab] = useState("inventory");

  return (
    <div className="w-full  pb-10">
      <LayoutWithBack title="FirstAid Inventory Reports" description="View and manage firstaid inventory reports including stock levels and restock needs.">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full h-full ">
          ...
          <div className="relative">
            <TabsContent value="inventory" className="mt-0">
              <MonthlyInventoryFirstAidRecords />
            </TabsContent>

            <TabsContent value="restock" className="mt-0">
              <FirstAidExpiredOutOfStockSummary />
            </TabsContent>
          </div>
        </Tabs>
      </LayoutWithBack>
