...
import AntigenExpiredOutOfStockSummary from "./expoutstock/monthly";
import MonthlyInventoryAntigenRecords from "./monthly";
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full h-full ">
          ...
          <div className="relative">
            <TabsContent value="inventory" className="mt-0">
              <MonthlyInventoryAntigenRecords />
            </TabsContent>

            <TabsContent value="restock" className="mt-0">
              <AntigenExpiredOutOfStockSummary />
            </TabsContent>
          </div>
        </Tabs>
      </LayoutWithBack>
