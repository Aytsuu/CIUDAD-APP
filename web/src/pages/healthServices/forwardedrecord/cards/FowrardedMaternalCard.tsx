...
interface ForwardedMaternalCardProps {
  count: number;
}

export function ForwardedMaternalCard({ count }: ForwardedMaternalCardProps) {
    ...
    <div className="p-4 rounded-lg border border-orange-200 mt-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Total Maternal Records</h3>
