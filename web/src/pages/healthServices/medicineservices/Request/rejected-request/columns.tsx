...
export const medicineRequestRejectedColumns: ColumnDef<any>[] = [
  {
    id: "index",
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="text-center py-2">
        <div className="font-semibold text-blue-600">{row.original.item_counts.rejected || 0}</div>
      </div>
    )
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex justify-center py-2">
          <ViewButton
            onClick={() => {
              navigate(`/services/medicine/requests/rejected/view`, {
                state: {
                  params: {
...
export const rejectedDetailsIColumns: ColumnDef<any>[] = [
    {
      id: "index",
      header: () => <div className="text-center">#</div>,
      size: 50,
