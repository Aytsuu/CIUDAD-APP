  ...
  return (
    <div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <EnhancedCardLayout title="Completed Medicine Requests" description="" icon={<FileInput size={24} />} value={totalCount} valueDescription="Total Completed Requests" cardClassName="mb-6" />
      </div>
        ...
        <div className="bg-white w-full overflow-x-auto">
          {isLoading ? (
            ...
            <div className="w-full h-[100px] flex items-center justify-center text-gray-500">
              <span className="ml-2">{debouncedSearch || dateFilter !== "all" ? "No records found matching your criteria" : "No records found"}</span>
            </div>
          ) : (
            <DataTable columns={medicineRequestCompletedColumns} data={medicineRequests} />
          )}
        </div>
