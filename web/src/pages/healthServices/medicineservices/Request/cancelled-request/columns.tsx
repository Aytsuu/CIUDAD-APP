...
export const medicineRequestCancelledColumns: ColumnDef<any>[] = [
  {
    id: "index",
...
export const cancelledDetailsIColumns: ColumnDef<any>[] = [
    {
      id: "index",
      header: () => <div className="text-center">#</div>,
      size: 50,
   ...
   
    {
   ...
   
      {
        ...
        header:"Reason",
        cell: ({ row }) => {
          const reason = row.original.archive_reason ? toTitleCase(row.original.archive_reason) : "No reason provided";
