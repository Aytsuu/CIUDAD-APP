...
import { medicineRequestCancelledColumns } from "./columns";
  ...
  return (
    <div>
       ...
       <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <EnhancedCardLayout title="Cancelled Medicine Requests" description="" icon={<FileInput size={24} />} value={totalCount} valueDescription="Total Cancelled Requests" cardClassName="mb-6" />
            </div>
      ...
      <div className="h-full w-full rounded-md">
        ...
        <div className="bg-white w-full overflow-x-auto">
          {isLoading ? (
            ...
            <DataTable columns={medicineRequestCancelledColumns} data={medicineRequests} />
          )}
        </div>
