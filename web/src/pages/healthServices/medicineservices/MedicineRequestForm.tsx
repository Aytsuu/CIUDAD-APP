...
import { SignatureFieldRef } from "../reports_tmp/firstaid-report/signature";
...
export default function MedicineRequestForm() {
  ...
  const onSubmit = useCallback(
    ...
    [selectedMedicines, submitMedicineRequest, staffId, hasPrescriptionMedicine, med_type]
  );
  ...
  const handlePreview = useCallback(() => {
    ...
    if (!patientCheck || selectedMedicines.length === 0) {
