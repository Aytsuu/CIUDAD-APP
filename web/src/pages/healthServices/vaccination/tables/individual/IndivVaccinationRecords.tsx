        ...
        <div className="flex flex-col sm:flex-row w-full items-center mb-4 gap-4 sm:gap-2">
          <div className="flex flex-col sm:flex-row gap-4 w-full">
            <div className="flex flex-col sm:flex-row gap-2 items-center justify-center ">
              ...
              <div>
                <p className="text-sm font-medium text-gray-800 pr-2 text-center sm:text-left">Total Medicine Records</p>
              </div>
              <p className="text-2xl font-bold text-gray-900 text-center sm:text-left">{vaccinationCount ?? 0}</p>
            </div>
            <div className="relative flex-1 w-full">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-black" size={17} />
              <Input placeholder="Search records..." className="pl-10 bg-white w-full" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
            </div>
          </div>
