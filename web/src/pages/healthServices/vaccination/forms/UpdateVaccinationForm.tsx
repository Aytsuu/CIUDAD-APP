...
export default function UpdateVaccinationForm() {
  ...
  const { vaccineStocksOptions, defaultVaccineStocks, isLoading } =
    fetchVaccinesWithStockVacID(vacId);
            ...
            <div>
              ...
              <Form {...form}>
                <form onSubmit={handleStep1Submit} className="space-y-6">
                  ...
                  <h2 className="font-semibold text-darkBlue2 ">
                    Vaccination Details
                  </h2>
