  ...
  const handleVaccineChange = (value: string) => {
    ...
    if (value) {
      ...
      if (selectedVaccine) {
        ...
        if (vaccinelist.vac_type_choices !== "conditional" && doseNumber < vaccinelist.no_of_doses) {
          if (vaccinelist.vac_type_choices === "routine") {
                ...
                <form onSubmit={handleStep1Submit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <FormInput control={form.control} name="vachist_doseNo" label="Dose Number" placeholder="Enter dose number" type="number" readOnly={mode !== "newvaccination_record"} />
                    </div>
                  </div>
