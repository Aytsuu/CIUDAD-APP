...
export default function ReferredTable() {
  ...
  return (
    <MainLayoutComponent
      title="Manage Referred Patients"
      description="View and  and manage all referred patient health records for consultations."
    >
      <div>
        <div className="w-full h-full flex flex-col">
          ...
          <div className="w-full flex flex-col  gap-2 py-4 px-4 border bg-white">
            {/* Filters Section */}
            <div className="w-full flex flex-col sm:flex-row gap-2">
              ...
              <Button variant="outline">
                <Link to="/referred-patients/upcoming-consultations" className="flex gap-2 justify-center items-center">
