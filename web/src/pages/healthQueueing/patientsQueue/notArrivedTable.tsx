...
export default function NotArriveTable() {
  ...
  const [filteredData, setFilteredData] = useState<NotArriveRec[]>(sampleData);
  const [currentData, setCurrentData] = useState<NotArriveRec[]>([]);
