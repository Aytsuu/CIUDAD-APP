...
import { usePopulationStructureReport } from "@/pages/healthServices/reports/healthprofiling-report/queries/fetchQueries.tsx";
...
export function PopulationAgePyramidChart({
  ...
  if (error) {
    return (
      <CardLayout
        title="Population Age Group Report"
