  ...
  },
  {
    ...
    items: [
      ...
      { title: "Vaccination", url: "/allVaccinationRecord" },
      {
        ...
        url: "/",
        anotherItems: [
          { title: "Medicine List", url: "/medicineList" },
          { title: "Commodity List", url: "/commodityList" },
          { title: "Vaccination List", url: "/vaccinationList" },
          { title: "FirstAid List", url: "/firstAidList" },
