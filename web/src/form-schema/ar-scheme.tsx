...
const ARSchema = z.object({
    name: z.string().min(2, { message: 'Must be atleast 2 characters.' }),
    dateStarted: z.string().date(),
    timeStarted: z.string().time(),
    dateCompleted: z.string().date(),
    timeCompleted: z.string().date(),
    sitio: z.string().min(1, { message: 'Required.' }),
    location: z.string().min(2, { message: 'Must be atleast 2 characters.' }),
