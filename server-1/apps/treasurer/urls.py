...
urlpatterns=[
    ...
    path('purpose-and-rate-business-permit-active/', Purpose_And_RatesBusinessPermitActiveView.as_view(), name='purpose-and-rate-business-permit-active'),
    path('purpose-and-rate-all-business-permit/', Purpose_And_RatesAllBusinessPermitView.as_view(), name='purpose-and-rate-all-business-permit'),
