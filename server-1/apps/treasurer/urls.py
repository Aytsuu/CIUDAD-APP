...
urlpatterns=[
    ...
    path('purpose-and-rate-personal/', Purpose_And_RatesPersonalView.as_view(), name='purpose-and-rate-personal'),
    path('purpose-and-rate-service-charge/', Purpose_And_RatesServiceChargeView.as_view(), name='purpose-and-rate-service-charge'),
    path('purpose-and-rate-business-permit/', Purpose_And_RatesBusinessPermitView.as_view(), name='purpose-and-rate-business-permit'),
