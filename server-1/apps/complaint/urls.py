...
from .views.complaint_anaylytics_view import *
...
urlpatterns = [
    ...
    path('analytics/cards/', ComplaintCardAnalyticsView.as_view(), name='complaint-analytics'),
    path('analytics/charts/', ComplaintChartAnalyticsView.as_view(), name='complaint-analytics'),
