...
#     gbud_receipt = models.CharField(null=False, default='')
...
#     gbudy_year = models.CharField(max_length=4)
...
class GAD_Budget_Year(models.Model):
    gbudy_num = models.BigAutoField(primary_key=True)
    gbudy_budget = models.DecimalField(max_digits=10, decimal_places=2)
    gbudy_year = models.CharField(max_length=4, unique=True)  # Ensure year is unique
    gbudy_expenses = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    gbudy_income = models.DecimalField(max_digits=10, decimal_places=2, default=0)
...
class GAD_Budget_Tracker(models.Model):
    ...
    gbud_amount = models.DecimalField(max_digits=10, decimal_places=2)
    gbud_add_notes = models.CharField(max_length=200, null=True)
    gbud_receipt = models.CharField(null=False, blank=True, default='')
    gbudy_num = models.ForeignKey(
        GAD_Budget_Year, 
