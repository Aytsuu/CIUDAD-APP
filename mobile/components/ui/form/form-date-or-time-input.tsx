...
//     } else {
//       // For time display, we'll show it in locale format
...
//         // Convert the stored value to a Date object for the picker
...
//           if (selectedDate) {
//             if (type === 'date') {
//               // Format as YYYY-MM-DD for Django DateField
//               const year = selectedDate.getFullYear();
//               const month = String(selectedDate.getMonth() + 1).padStart(2, '0');
//               const day = String(selectedDate.getDate()).padStart(2, '0');
//               onChange(`${year}-${month}-${day}`);
//             } else {
//               // Format as HH:MM for Django TimeField
