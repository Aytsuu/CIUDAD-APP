...
<<<<<<< HEAD
        ...
        <Stack.Screen name="attendance/main-attendance-page" options={{ headerShown: false, animation: 'fade' }} />
        <Stack.Screen name="attendance/attendance-info" options={{ headerShown: false, animation: 'fade' }} />

        <Stack.Screen name="template/template-main-page" options={{ headerShown: false, animation: 'fade' }} />
        <Stack.Screen name="template/template-view-page" options={{ headerShown: false, animation: 'fade' }} />    

        <Stack.Screen name="resolution/res-main" options={{ headerShown: false, animation: 'fade' }} />  
        <Stack.Screen name="resolution/res-create" options={{ headerShown: false, animation: 'fade' }} />
        <Stack.Screen name="resolution/res-edit" options={{ headerShown: false, animation: 'fade' }} />       

        <Stack.Screen name="minutes-of-meeting/mom-view" options={{ headerShown: false, animation: 'fade' }} />
