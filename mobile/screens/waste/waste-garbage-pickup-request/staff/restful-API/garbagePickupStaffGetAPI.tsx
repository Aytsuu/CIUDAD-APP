...
export const getGarbagePendingRequest = async (page: number, pageSize: number, searchQuery: string) => {
    try {
        const res = await api.get('waste/garbage-pickup-request-pending/', {
            params: {   
                page,
                page_size: pageSize,
                search: searchQuery
...
export const getGarbagePendingRequestDetails = async (garb_id: string) => {
    try {
...
export const getGarbageRejectedRequest = async (page: number, pageSize: number, searchQuery: string) => {
  try {    
    const res = await api.get("waste/garbage-pickup-request-rejected/", {
      params: {
        page,
        page_size: pageSize,
        search: searchQuery
...
export const getGarbageRejectedRequestDetails = async (garb_id: string) => {
    try {
...
export const getGarbageAcceptedRequest = async (page: number, pageSize: number, searchQuery: string) => {
    try {
        const res = await api.get('waste/garbage-pickup-request-accepted/', {
            params: {
                page,
                page_size: pageSize,
                search: searchQuery
...
export const getGarbageCompletedRequest = async (page: number, pageSize: number, searchQuery: string) => {
    try {
        const res = await api.get('waste/garbage-pickup-request-completed/', {
            params: {
                page,
                page_size: pageSize,
                search: searchQuery
