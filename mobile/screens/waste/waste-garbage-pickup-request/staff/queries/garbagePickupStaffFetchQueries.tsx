...
import { getTrucks, getDrivers, getCollectors, getGarbageAcceptedRequest, getGarbageCompletedRequest, getGarbagePendingRequest, getGarbageRejectedRequest, getAcceptedDetails, getCompletedDetails } from "../restful-API/garbagePickupStaffGetAPI";
