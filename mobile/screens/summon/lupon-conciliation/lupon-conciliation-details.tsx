...
export default function LuponConciliationDetails() {
    ...
    // Use conciliation status if not null, otherwise use mediation status (like web version)
                ...
                <Card className="border-2 border-gray-200 shadow-sm bg-white mb-4">
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <View className="flex-row justify-between items-center py-2 border-b border-gray-100">
                            ...
                            <View className={`px-3 py-1 rounded-full border ${getStatusColor(sc_conciliation_status)}`}>
                                <Text className="text-sm font-medium">
                                    {sc_conciliation_status || "No Status"}
                                </Text>
                            </View>
                        </View>
                    ...
                    <CardHeader className="flex-row justify-between items-center">
                        <View className="flex-row items-center space-x-2">
                            ...
                            <Text className="text-md font-bold text-gray-900">
                                Complainant{complainantNames.length > 1 ? 's' : ''}
                            </Text>
                        </View>
                        {hasResidentBool && (
                            <View className="bg-green-100 px-2 py-1 rounded-full border border-green-200">
                ...
                <Card className="border-2 border-gray-200 shadow-sm bg-white mb-4">
                    <CardHeader>
                        <View className="flex-row items-center space-x-2">
                            ...
                            <Text className="text-md font-bold text-gray-900">
                                Respondent{accusedNames.length > 1 ? 's' : ''}
                            </Text>
                        </View>
                    </CardHeader>
                    <CardContent>
                                ...
                                <ConfirmationModal
                                    trigger={
                                        ...
                                        >
                                            ...
                                            <Text className="text-white font-semibold ml-2">Escalate</Text>
                                        </Button>
                                    }
