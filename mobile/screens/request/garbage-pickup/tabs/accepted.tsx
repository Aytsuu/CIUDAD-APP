...
//                         <View className="mt-2">
//                           <Text className="text-sm text-gray-600">Assigned Team:</Text>
//                           <Text className="text-sm">
//                             Driver: {request.assignment_info.driver || "Not assigned"}
//                           </Text>
//                           {request.assignment_info.collectors && request.assignment_info.collectors.length > 0 && (
//                             <Text className="text-sm">
//                               Collectors: {request.assignment_info.collectors.join(", ")}
//                             </Text>
//                           )}
//                         </View>
//                       )}
