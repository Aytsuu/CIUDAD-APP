...
import ActiveBudgetPlanScreen from "./budgetplan-active";
import InactiveBudgetPlanScreen from "./budgetplan-inactive";
        ...
        <View className="flex-1 bg-gray-50">
          ...
          <View className="px-6 flex-1">
            <Tabs value={activeTab} onValueChange={val => handleTabChange(val as 'active' | 'archive')} className="flex-1">
              ...
              {/* Active Tab Content */}
              <TabsContent value="active" className="flex-1 mt-4">
                <ActiveBudgetPlanScreen searchQuery={searchQuery} />
              </TabsContent>

              {/* Archive Tab Content */}
              <TabsContent value="archive" className="flex-1 mt-4">
                <InactiveBudgetPlanScreen searchQuery={searchQuery} />
              </TabsContent>
            </Tabs>
          </View>
        </View>
