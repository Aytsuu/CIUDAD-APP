  ...
  const menuItem = [
    {
      ...
      route: "/(treasurer)/budget-tracker/budget-income-expense-main",
      icon: "",
      gradient: ['#60a5fa', '#3b82f6'],
    },
    {
      title: "Receipt",
      route: "/(treasurer)/receipt/receipt-main",
      icon: "",
      gradient: ['#3b82f6', '#2563eb'],
    },
    {
      title: "Rates & Purposes",
      route: "/(treasurer)/rates/purpose-and-rate-main",
      icon: "",
      gradient: ['#2563eb', '#1e40af'],
    },
    {
      title: "Disbursement Voucher",
      route: "/(treasurer)/disbursementVoucher/disb-main",
      icon: "",
      gradient: ['#06b6d4', '#0891b2'],
    },
    {
      title: "Budget Plan",
      route: "/(treasurer)/budgetPlan/budget-plan-main",
      icon: "",
...
//         description="The treasurer features are only available to authorized treasury personnel."
//       />
//     )
//   }
