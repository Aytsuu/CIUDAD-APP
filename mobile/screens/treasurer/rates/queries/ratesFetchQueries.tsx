...
import { getAnnualGrossSalesActive, getAllAnnualGrossSales, getPurposeAndRate, getPurposeAndRateAllPersonal,
    getPurposeAndRateAllBarangayPermit, getPurposeAndRateAllServiceCharge, getPurposeAndRateBarangayPermitActive,
    getPurposeAndRatePersonalActive, getPurposeAndRateServiceChargeActive
 } from "../restful-API/ratesGetAPI";
