...
//       result = result.filter(item => item.rep_status !== 'resolved' && item.rep_status !== 'cancelled');
...
//         {/* Tabs */}
//         <Tabs value={activeTab} onValueChange={(val) => setActiveTab(val as 'pending' | 'resolved' | 'cancelled')}>
//           <TabsList className="bg-blue-50 mb-5 mt-2 flex-row justify-between">
//             <TabsTrigger
//               value="pending"
//               className={`flex-1 mx-1 ${activeTab === 'pending' ? 'bg-white border-b-2 border-primaryBlue' : ''}`}
