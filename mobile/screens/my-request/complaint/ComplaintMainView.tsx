...
//             <TouchableOpacity 
//               onPress={() => router.push({
//                 pathname: "/(my-request)/complaint-tracking/case-tracking",
//                 params: { comp_id: params.comp_id, isRaised: fetchedComplaint.comp_status}
//               })}
//               className="bg-blue-500 px-6 py-3 rounded-lg"
//             >
//               {/* <Text className="text-white font-semibold">View Case Tracking</Text> */}
//             </TouchableOpacity>
//           </View>
//           )}
//         </View>
