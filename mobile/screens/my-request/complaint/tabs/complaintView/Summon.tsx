...
import { useGetSummonDates, useGetSummonTimeSlots, type SummonTimeSlots } from "../../api-operations/queries/SummonFetchQueries";
import { useLocalSearchParams } from "expo-router";
import { useGetScheduleList } from "../../api-operations/queries/SummonFetchQueries";
    ...
    <View className="flex-1 bg-gray-50">
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        <View className="p-6">
          ...
          {/* Calendar Card */}
          {!isLoadingSchedule && !isLoadingDates && summonDates.length > 0 && (
