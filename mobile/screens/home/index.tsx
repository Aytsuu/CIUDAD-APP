  ...
  return (
    ...
    >
      <View className="flex-1 mb-16" >
          ...
          >
            ...
            >
              <Card className="w-[200px] h-[120px] border-0 bg-gray-400 justify-center items-center shadow-lg">
                ...
                <Text className="text-white/80 text-sm mt-1">Discover new content</Text>
              </Card>
            </TouchableOpacity>
            ...
            >
              <Card className="w-[200px] h-[120px] border-0 bg-gray-400 justify-center items-center shadow-lg">
                <Text className="text-white font-semibold text-lg">Trending</Text>
                <Text className="text-white/80 text-sm mt-1">Popular right now</Text>
              </Card>
            </TouchableOpacity>
            ...
            >
              <Card className="w-[200px] h-[120px] border-0 bg-gray-400 justify-center items-center shadow-lg">
                <Text className="text-white font-semibold text-lg">For You</Text>
                <Text className="text-white/80 text-sm mt-1">Personalized picks</Text>
              </Card>
            </TouchableOpacity>
          </ScrollView>
        </View>
        ...
        {/* Features Section */}
        <Card className="p-5 rounded-none bg-white">
        ...
        <View className="px-5 py-6">
          <View className="mb-6">
            <Text className="text-xl font-semibold text-gray-900">What's New For You</Text>
            <Text className="text-sm text-gray-600">Latest updates and recommendations</Text>
          </View>
            ...
            >
              <Card className="p-4 bg-white shadow-sm border border-gray-100">
                <View className="flex-row items-center">
                  ...
                  <View className="flex-1">
                    <Text className="font-semibold text-gray-900 mb-1">App Update</Text>
                    <Text className="text-sm text-gray-600">Version 2.1 is now available with bug fixes</Text>
                  </View>
                </View>
              </Card>
            </TouchableOpacity>
            ...
            >
              <Card className="p-4 bg-white shadow-sm border border-gray-100">
                <View className="flex-row items-center">
                  ...
                  <View className="flex-1">
                    <Text className="font-semibold text-gray-900 mb-1">Recommended for You</Text>
                    <Text className="text-sm text-gray-600">Based on your activity, you might like this</Text>
                  </View>
                </View>
              </Card>
            </TouchableOpacity>
