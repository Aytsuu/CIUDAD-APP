    ...
    if (isError) {
        ...
        return (
            <View className="flex-1 bg-gray-50 items-center justify-center p-6">
                ...
                <Text className="text-lg text-red-600 mr-2">Failed to load record</Text>
                <Text className="text-sm text-gray-500 mr-2 text-center">{error?.message}</Text>
                <Text className="text-sm text-gray-400 mr-2">Trying to load ID: {String(fprecordId)}</Text>
            </View>
        );
    }
    ...
    if (!recordData) {
        ...
        return (
            <View className="flex-1 bg-gray-50 items-center justify-center p-6">
                ...
                <Text className="text-lg text-gray-600 mr-2">Record not found</Text>
                <Text className="text-sm text-gray-400 mr-2">ID: {String(fprecordId)}</Text>
                <Text className="text-sm text-gray-400 mr-2">Type: {typeof fprecordId}</Text>
                <TouchableOpacity
                    onPress={() => router.back()}
                    className="mr-2 bg-blue-600 px-4 py-2 rounded-lg"
                >
            ...
            case 0: // Client Information
                return (
                    <View className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        ...
                        {recordData.spouse?.s_givenName && (
                            <View className="flex-row items-start space-x-3 mb-4">
                                <View className="w-5 h-5 mr-2">
                                    <User size={18} color="#6B7280" />
                                </View>
                                <View className="flex-1">
                                    <Text className="text-sm text-gray-500 mb-1">Spouse</Text>
                                    <Text className="text-sm font-medium text-gray-900">
                                        {recordData.spouse.s_givenName} {recordData.spouse.s_middleInitial}. {recordData.spouse.s_lastName}
                                    </Text>
                                    <Text className="text-sm font-medium text-gray-900">
                                        {recordData.spouse.s_age} years old
                                    </Text>
                                </View>
                            </View>
                        )}
                ...
                return (
                    <View className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        ...
                        <View className="flex-row items-start space-x-3 mb-4">
                            ...
                            <View className="flex-1">
                                <Text className="text-sm text-gray-500 mb-1">Sub Type</Text>
                        ...
                        <View className="flex-row items-start space-x-3 mb-4">
                            ...
                            <View className="flex-1">
                                ...
                                <Text className="text-sm font-medium text-gray-900">
                                    {recordData.fp_type?.fpt_reason ?? recordData.reasonForFP ?? "N/A"}
                                </Text>
                            </View>
                        </View>
                        <View className="flex-row items-start space-x-3 mb-4">
                        ...
                        <View className="border-t border-gray-100 pt-4 mr-2">
                        ...
                        <View className="border-t border-gray-100 pt-4">
                            ...
                            <View className="flex-row mb-3">
                                <View className="bg-gray-50 rounded-lg p-4 items-center flex-1 mx-1">
                                    ...
                                    <Text className="text-sm font-bold text-blue-600">{recordData.obstetricalHistory?.g_pregnancies ?? "0"}</Text>
                                    <Text className="text-sm text-gray-500 text-center">Gravida</Text>
                                </View>
                                <View className="bg-gray-50 rounded-lg p-4 items-center flex-1 mx-1">
                                    <Baby size={20} color="#3B82F6" />
                                    <Text className="text-sm font-bold text-blue-600">{recordData.obstetricalHistory?.p_pregnancies ?? "0"}</Text>
                                    <Text className="text-sm text-gray-500 text-center">Para</Text>
                                </View>
                                <View className="bg-gray-50 rounded-lg p-4 items-center flex-1 mx-1">
                                    <Heart size={20} color="#3B82F6" />
                                    <Text className="text-sm font-bold text-blue-600">{recordData.obstetricalHistory?.numOfLivingChildren ?? "0"}</Text>
                                    <Text className="text-sm text-gray-500 text-center">Living Children</Text>
                                </View>
                            </View>
                            <View className="flex-row">
                                <View className="bg-gray-50 rounded-lg p-4 items-center flex-1 mx-1">
                                    <Calendar size={20} color="#3B82F6" />
                                    <Text className="text-sm font-bold text-blue-600">{recordData.obstetricalHistory?.fullTerm ?? "0"}</Text>
                                    <Text className="text-sm text-gray-500 text-center">Full Term</Text>
                                </View>
                                <View className="bg-gray-50 rounded-lg p-4 items-center flex-1 mx-1">
                                    <Clock size={20} color="#3B82F6" />
                                    <Text className="text-sm font-bold text-blue-600">{recordData.obstetricalHistory?.premature ?? "0"}</Text>
                                    <Text className="text-sm text-gray-500 text-center">Premature</Text>
                                </View>
                                <View className="bg-gray-50 rounded-lg p-4 items-center flex-1 mx-1">
                                    <AlertCircle size={20} color="#3B82F6" />
                                    <Text className="text-sm font-bold text-blue-600">{recordData.obstetricalHistory?.abortion ?? "0"}</Text>
                                    <Text className="text-sm text-gray-500 text-center">Abortion</Text>
                                </View>
                            </View>
                        </View>
                    </View>
                        ...
                        <View className="border-t border-gray-100 pt-4 mr-2">
                            ...
                            <View className="flex-row flex-wrap">
                                <View className="bg-gray-50 rounded-lg p-3 items-center flex-1 mx-1 mb-2">
                                    ...
                                    <Text className="text-sm font-bold text-blue-600">{recordData.weight ?? "N/A"}</Text>
                                    <Text className="text-xs text-gray-500 text-center mr-2">Weight (kg)</Text>
                                </View>
                                <View className="bg-gray-50 rounded-lg p-3 items-center flex-1 mx-1 mb-2">
                                    <Ruler size={20} color="#10B981" />
                                    <Text className="text-sm font-bold mr-2 text-green-600">{recordData.height ?? "N/A"}</Text>
                                    <Text className="text-xs text-gray-500 text-center mr-2">Height (cm)</Text>
                                </View>
                                <View className="bg-gray-50 rounded-lg p-3 items-center flex-1 mx-1 mb-2">
                                    <Heart size={20} color="#EF4444" />
                                    <Text className="text-sm font-bold mr-2 text-red-600">{recordData.bloodPressure ?? "N/A"}</Text>
                                    <Text className="text-xs text-gray-500 text-center mr-2">Blood Pressure</Text>
                                </View>
                                <View className="bg-gray-50 rounded-lg p-3 items-center flex-1 mx-1 mb-2">
                                    <Heart size={20} color="#EF4444" />
                                    <Text className="text-sm font-bold mr-2 text-red-600">{recordData.pulseRate ?? "N/A"}</Text>
                                    <Text className="text-xs text-gray-500 text-center mr-2">Pulse Rate</Text>
                                </View>
                            </View>
                        </View>
                    </View>
                        ...
                        <View className="mr-2">
                            ...
                            {recordData.acknowledgement?.clientSignature ? (
                                ...
                                <View className="bg-gray-50 rounded-lg p-6 items-center">
                                    ...
                                    <Text className="text-sm text-gray-500 mr-2">No signature available</Text>
                                </View>
                            )}
                        </View>
    ...
    return (
        <View className="flex-1 bg-gray-50">
            ...
            <ScrollView
                ...
                className="bg-white border-b mr-2 p-1 border-gray-200"
            ...
            >
                {tabs.map((tab, index) => (
                    <TouchableOpacity
                        ...
                        className={`px-3 py-2 mr-2 rounded-t-lg ${selectedTab === index ? "bg-blue-50 border-b-2 border-blue-600" : "bg-transparent"
                            }`}
                        style={{ minHeight: 40 }}
                    >
