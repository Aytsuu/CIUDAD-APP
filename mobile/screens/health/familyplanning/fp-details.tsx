...
return (
    <View className="flex-1 bg-gray-50 items-center justify-center p-6">
        ...
        <Text className="text-sm text-gray-400 mt-4">Trying to load ID: {String(fprecordId)}</Text>
    </View>
);
}
...
return (
    <View className="flex-1 bg-gray-50 items-center justify-center p-6">
        ...
        <Text className="text-sm text-gray-400 mt-1">ID: {String(fprecordId)}</Text>
        <Text className="text-sm text-gray-400 mt-2">Type: {typeof fprecordId}</Text>
        <TouchableOpacity
            onPress={() => router.back()}
