          ...
          <View className="space-y-4">
            <View className="grid space-x-3">
              <View className="flex-1">
                <FormInput control={control} label="First Name" name="personalSchema.per_fname" />
              </View>
              <View className="flex-1">
                <FormInput control={control} label="Last Name" name="personalSchema.per_lname" />
              </View>
            </View>

            <View className="flex-row gap-2">
              <View className="flex-1">
                <FormInput control={control} label="Middle Name" name="personalSchema.per_mname" />
              </View>
              <View className="w-24">
                <FormInput control={control} label="Suffix" name="personalSchema.per_suffix" placeholder="Jr, Sr" />
              </View>
            </View>
          </View>
        </View>
