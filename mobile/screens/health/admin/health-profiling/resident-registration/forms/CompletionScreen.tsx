...
const stepDetails = [
  { id: 0, label: "Account Setup", icon: CircleUserRound, required: false },
  { id: 1, label: "Personal Information", icon: UserRoundPlus, required: true },
  { id: 2, label: "Household Details", icon: HousePlus, required: false },
  { id: 3, label: "Family Information", icon: UsersRound, required: false },
];
            ...
            <View className="flex-row items-start">
              ...
              <View className="flex-1">
                ...
                <Text className="text-amber-700 text-sm">
                  Please complete the Personal Information section to proceed with registration. Account verification is optional unless you enter account data.
                </Text>
              </View>
            </View>
          </View>
