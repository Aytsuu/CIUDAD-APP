...
// import { ChevronLeft, Edit, AlertCircle, View, Badge } from "lucide-react"
...
// import { useVaccinationCount } from "../../vaccination/queries/VacCount"
// import { useChildHealthRecords } from "../admin-childhealth/forms/queries/fetchQueries"
// import { useChildHealthRecordCount, useMedConCount } from "../restful-api/patientsrecord/queries/count"
// import { usePatientDetails } from "../restful-api/patientsrecord/queries/fetch"
// import { useCompletedFollowUpVisits, usePendingFollowUpVisits } from "../restful-api/patientsrecord/queries/followv"
// import { useUpdatePatient } from "../restful-api/patientsrecord/queries/update"
// import { patientRecordSchema } from "./patients-record-schema"
...
//       console.log("InViewidual Address Fields:", {
...
//       <View className="flex flex-col sm:flex-row sm:items-center gap-3 mb-4">
...
//         </View>
//         <View className="flex gap-2 sm:ml-auto">
...
//           description=""
//           content={
//             <View className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
...
//                 </h2>
//                 <View className="flex flex-wrap gap-2 text-sm text-muted-foreground">
//                   <span>
