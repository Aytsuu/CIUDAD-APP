...
export default function AnimalBiteIndividualScreen() {
  ...
  // MODIFIED: Use a single page change handler for the component
  ...
  if (!patientId || !patientInfo) {
    // ... (no patient data code remains the same)
    return (
    ...
    >
      <View className="flex-1 bg-blue-50">
        ...
        >
          ...
          <View className="p-4">
            {/* ... (patient card JSX remains the same) */}
              ...
              <View className="flex-row justify-between">
                ...
                <View className="items-center">
                  <Text className="text-3xl font-bold text-green-600">
                    {records?.filter((r: { exposure_type: string }) => r.exposure_type?.toLowerCase() === "bite").length ||
                      0}
                  </Text>
          ...
          <View className="px-4 pb-6">
            ...
            {records && records.length > 0 ? (
              <View>
                ...
                {/* --- MODIFIED: Replaced buttons with PaginationControls component --- */}
