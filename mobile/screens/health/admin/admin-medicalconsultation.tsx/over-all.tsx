...
// import { Search, ChevronLeft, AlertCircle, Users, Home, UserCheck, FileText } from "lucide-react-native";
...
// export default function AllMedicalRecordsMobile() {
...
//       const addressString = [address.add_street, address.add_barangay, address.add_city, address.add_province]
...
//     const residentCount = formattedData.filter((r) => 
//       r.pat_type.toLowerCase() === "resident"
//     ).length;
//     const transientCount = formattedData.filter((r) => 
//       r.pat_type.toLowerCase() === "transient"
//     ).length;
...
//           per_dob: record.dob,
//           per_sex: record.sex,
//           per_contact: record.contact
//         }
//       };

//       router.push({
//         pathname: "/(services)/medical-consultation/records",
//         params: { 
...
//                 cardClassName="border shadow-sm rounded-lg bg-white"
...
//           <View className="flex-row items-center px-3 border border-gray-300 bg-gray-50 rounded-xl">
//             <Search size={20} color="#6B7280" />
//             <TextInput 
//               className="flex-1 ml-3 text-gray-800 text-base py-3"
//               placeholder="Search by name, patient ID, household number..."
...
//               {searchQuery ? "No records match your search criteria." : "There are no medical records available yet."}
//             </Text>
//           </View>
//         ) : (
//           <>
...
//                   showMedicalCount={true}
//                 />
//               )}
//               ListFooterComponent={
//                 isFetching ? (
//                   <View className="py-4 items-center">
//                     <Text className="text-gray-600">Loading more records...</Text>
//                   </View>
//                 ) : null
//               }
//             />
