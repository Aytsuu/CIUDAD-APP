...
const carousel = [
  ...
  },
  {
    ...
    description: "Easily request assistance, permits, and other barangay services online.",
  },
  {
    id: 3,
    image: require("@/assets/images/Login/carousel3.jpg"),
    title: "Health Services",
    description: "Stay informed and connected with local health programs and support.",
  },
];
...
export default function App() {
  ...
  const handleSignUp = useMemo(() => () => setShowSignupOptions(true), []);
