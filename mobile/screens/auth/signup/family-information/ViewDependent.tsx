  ...
  return (
    ...
    >
      <View className="flex-1">
        ...
        {isEdit ?
            <View>
                <Button onPress={()=> {setIsEdit(false)}} className="bg-primaryBlue native:h-[57px]">
                    <Text className="text-white font-bold text-[16px]">Save</Text>
                </Button>
            </View> :
            <View className="flex-row justify-end">
                <Button onPress={()=> {setIsEdit(true)}} className="bg-gray-400 w-[57px] native:h-[57px] rounded-full">
                    <Pen fill="white"/>
                </Button>
            </View>
        }
