    ...
    waiting: {
      title: (
        <View className="flex gap-2">
          ...
          <View>
            <Text className={`text-[14px] text-gray-800 font-PoppinsRegular text-center`}>
            ...
            <View className="flex-row items-center mb-4">
              <View className="flex-1">
                <Text className="text-gray-50 text-xs font-medium">
                  Business No: {businessInfo?.bus_id}
                </Text>
          ...
          <View className="bg-white p-6 shadow-sm">
            ...
            <View className="flex-row items-center gap-2">
              ...
              <Text className="text-green-600 text-sm">
                Verified on {formatDate(businessInfo?.bus_date_verified, "short" as any)}
              </Text>
            </View>
          </View>
